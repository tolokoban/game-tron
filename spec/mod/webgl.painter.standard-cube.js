...
/** @module webgl.painter.standard-cube */
require('webgl.painter.standard-cube', function (require, module, exports) {
  var _ = function _() {
    return '';
  };
  ...
  */
  ...
  /*#__PURE__*/
  function () {
    function StandardCube(gl) {
      _classCallCheck(this, StandardCube);
    ...
    _createClass(StandardCube, [{
      key: "translateTo",
      value: function translateTo(x, y, z) {
        this.location[0] = x;
        this.location[1] = y;
        this.location[2] = z;
      }
      ...
      key: "paint",
      value: function paint(cameraMatrix) {
        var gl = this.gl,
            prg = this.prg,
  ...
  function createVertexBuffer(gl) {
    ...
    margin = 0.01,
        ...
        zn0v = yn0v + texH,
        zn1v = yn1v + texH,
        vert = new Float32Array([// +X
    f, b, b, xp0u, xp1v, f, f, b, xp1u, xp1v, f, f, f, xp1u, xp0v, f, b, b, xp0u, xp1v, f, f, f, xp1u, xp0v, f, b, f, xp0u, xp0v, // -X
    b, b, b, xn0u, xn1v, b, f, f, xn1u, xn0v, b, f, b, xn1u, xn1v, b, b, b, xn0u, xn1v, b, b, f, xn0u, xn0v, b, f, f, xn1u, xn0v, // +Y
    b, f, b, yp0u, yp1v, f, f, b, yp1u, yp1v, f, f, f, yp1u, yp0v, b, f, b, yp0u, yp1v, f, f, f, yp1u, yp0v, b, f, f, yp0u, yp0v, // -Y
    b, b, b, yn0u, yn1v, f, b, f, yn1u, yn0v, f, b, b, yn1u, yn1v, b, b, b, yn0u, yn1v, b, b, f, yn0u, yn0v, f, b, f, yn1u, yn0v, // +Z
    b, b, f, zp0u, zp1v, f, b, f, zp1u, zp1v, f, f, f, zp1u, zp0v, b, b, f, zp0u, zp1v, f, f, f, zp1u, zp0v, b, f, f, zp0u, zp0v, // -Z
    b, b, b, zn0u, zn1v, f, f, b, zn1u, zn0v, f, b, b, zn1u, zn1v, b, b, b, zn0u, zn1v, b, f, b, zn0u, zn0v, f, f, b, zn1u, zn0v]),
  ...
  function createCanvas(size) {
    ...
    ctx.font = "bold ".concat(size / 3, "px sans-serif");
