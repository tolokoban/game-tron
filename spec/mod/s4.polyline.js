  ...
  function () {
    ...
    _createClass(Polyline, [{
      ...
      value: function move(dx, dy) {
        ...
        var segmentLength = Math.max(Math.abs(this._arr[index + IDX_X10] - this._arr[index + IDX_X00]), Math.abs(this._arr[index + IDX_Y10] - this._arr[index + IDX_Y00]));
        this._arr[index + IDX_U10] = this._arr[index + IDX_U11] = this._arr[index + IDX_U00] + segmentLength;
      }
      /**
      ...
      value: function add() {
        ...
        arr[nextIndex + IDX_X01] = arr[nextIndex + IDX_X11] = x;
        arr[nextIndex + IDX_Y00] = arr[nextIndex + IDX_Y10] = y;
        arr[nextIndex + IDX_Y01] = arr[nextIndex + IDX_Y11] = y;
        arr[nextIndex + IDX_U00] = arr[nextIndex + IDX_U10] = u;
        arr[nextIndex + IDX_U01] = arr[nextIndex + IDX_U11] = u;
